-- Additive Accounting Documents V1 (commercial Quote/Invoice).
-- Does NOT alter QuoteRequest (visitor enquiry) or platform billing.
-- Rollback: DROP TABLE AccountingDocumentShare, AccountingDocumentLine, AccountingDocument,
--           AccountingDocumentSequence, BusinessBillingProfile (in that order).
...
ALTER TABLE "BusinessBillingProfile" ADD CONSTRAINT "BusinessBillingProfile_storeId_fkey"
...
CREATE TABLE "AccountingDocumentSequence" (
    ...
    CONSTRAINT "AccountingDocumentSequence_pkey" PRIMARY KEY ("id")
);

CREATE UNIQUE INDEX "AccountingDocumentSequence_storeId_documentType_key"
  ON "AccountingDocumentSequence"("storeId", "documentType");
CREATE INDEX "AccountingDocumentSequence_storeId_idx" ON "AccountingDocumentSequence"("storeId");

ALTER TABLE "AccountingDocumentSequence" ADD CONSTRAINT "AccountingDocumentSequence_storeId_fkey"
  FOREIGN KEY ("storeId") REFERENCES "Business"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
CREATE UNIQUE INDEX "AccountingDocument_storeId_documentNumber_key"
  ON "AccountingDocument"("storeId", "documentNumber");
CREATE INDEX "AccountingDocument_storeId_type_status_idx"
  ON "AccountingDocument"("storeId", "type", "status");
CREATE INDEX "AccountingDocument_storeId_updatedAt_idx"
  ON "AccountingDocument"("storeId", "updatedAt");
...
ALTER TABLE "AccountingDocument" ADD CONSTRAINT "AccountingDocument_storeId_fkey"
  FOREIGN KEY ("storeId") REFERENCES "Business"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "AccountingDocumentLine" ADD CONSTRAINT "AccountingDocumentLine_documentId_fkey"
...
CREATE TABLE "AccountingDocumentShare" (
    ...
    CONSTRAINT "AccountingDocumentShare_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "AccountingDocumentShare" ADD CONSTRAINT "AccountingDocumentShare_storeId_fkey"
  FOREIGN KEY ("storeId") REFERENCES "Business"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "AccountingDocumentShare" ADD CONSTRAINT "AccountingDocumentShare_documentId_fkey"
  FOREIGN KEY ("documentId") REFERENCES "AccountingDocument"("id") ON DELETE CASCADE ON UPDATE CASCADE;
