...
CREATE TABLE "MarketplaceSellerProfile" (
    ...
    "rightsPolicyAcceptedAt" TIMESTAMP(3),
    "applicationBio" TEXT,
    "applicationMotivation" TEXT,
    "applicationPortfolioUrl" TEXT,
    "applicationLanguages" JSONB,
...
CREATE TABLE "MarketplaceSellerStatusEvent" (
    ...
    CONSTRAINT "MarketplaceSellerStatusEvent_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "MarketplaceOwnershipDeclaration" (
    ...
    CONSTRAINT "MarketplaceOwnershipDeclaration_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "MarketplaceAssetProvenance" (
    ...
    CONSTRAINT "MarketplaceAssetProvenance_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "MarketplaceSellerProfile" ADD CONSTRAINT "MarketplaceSellerProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "MarketplaceSellerProfile" ADD CONSTRAINT "MarketplaceSellerProfile_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "Creator"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "MarketplaceSellerStatusEvent" ADD CONSTRAINT "MarketplaceSellerStatusEvent_sellerId_fkey" FOREIGN KEY ("sellerId") REFERENCES "MarketplaceSellerProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "MarketplaceListing" ADD CONSTRAINT "MarketplaceListing_sellerId_fkey" FOREIGN KEY ("sellerId") REFERENCES "MarketplaceSellerProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "MarketplaceListing" ADD CONSTRAINT "MarketplaceListing_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "Creator"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "MarketplaceListing" ADD CONSTRAINT "MarketplaceListing_sourceContentId_fkey" FOREIGN KEY ("sourceContentId") REFERENCES "CreatorContent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "MarketplaceOwnershipDeclaration" ADD CONSTRAINT "MarketplaceOwnershipDeclaration_listingId_fkey" FOREIGN KEY ("listingId") REFERENCES "MarketplaceListing"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "MarketplaceAssetProvenance" ADD CONSTRAINT "MarketplaceAssetProvenance_listingId_fkey" FOREIGN KEY ("listingId") REFERENCES "MarketplaceListing"("id") ON DELETE CASCADE ON UPDATE CASCADE;
