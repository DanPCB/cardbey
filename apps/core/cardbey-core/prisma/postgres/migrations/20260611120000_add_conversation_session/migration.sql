...
ALTER TABLE "conversation_sessions" ADD CONSTRAINT "conversation_sessions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "conversation_messages" ADD CONSTRAINT "conversation_messages_mission_id_fkey" FOREIGN KEY ("mission_id") REFERENCES "MissionPipeline"("id") ON DELETE SET NULL ON UPDATE CASCADE;
