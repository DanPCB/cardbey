-- Additive multi-market + prebuilt store V1 tables (SQLite)
...
CREATE TABLE IF NOT EXISTS "multi_market_discovery_job" (
    ...
    "campaignId" TEXT,
    "pilotId" TEXT,
    "dryRun" BOOLEAN NOT NULL DEFAULT 1,
    "slowMode" BOOLEAN NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "public_business_card" (
    ...
    "noindex" BOOLEAN NOT NULL DEFAULT 1,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "prebuilt_store_draft" (
    ...
    "publicFeedExcluded" BOOLEAN NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS "prebuilt_offering_draft" (
    ...
    "ownerAccepted" BOOLEAN NOT NULL DEFAULT 0,
    "source" TEXT,
    "included" BOOLEAN NOT NULL DEFAULT 0,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "prebuilt_offering_draft_draftId_fkey" FOREIGN KEY ("draftId") REFERENCES "prebuilt_store_draft" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "prebuilt_asset_draft" (
    ...
    "confidence" REAL,
    "ownerApprovalRequired" BOOLEAN NOT NULL DEFAULT 1,
    "attributionRequired" BOOLEAN NOT NULL DEFAULT 0,
    "contentHash" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "prebuilt_asset_draft_draftId_fkey" FOREIGN KEY ("draftId") REFERENCES "prebuilt_store_draft" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "prebuilt_field_evidence" (
    ...
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "prebuilt_field_evidence_draftId_fkey" FOREIGN KEY ("draftId") REFERENCES "prebuilt_store_draft" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
