...
export const VERTICALS = [
  ...
  // Finance before accounting so name hits like "capital" / "investment" prefer capital advisory.
  { slug: 'services.finance', group: 'services', label: 'Finance & Capital', keywords: ['finance', 'financial', 'financial advisor', 'financial advisory', 'capital', 'investment', 'investments', 'private equity', 'wealth', 'asset management', 'venture capital', 'fund', 'banking'] },
  { slug: 'services.accounting', group: 'services', label: 'Accounting', keywords: ['accountant', 'accounting', 'bookkeeping', 'bookkeeper', 'tax return', 'tax agent', 'bas', 'payroll', 'stp'] },
