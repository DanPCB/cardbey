...
export const VERTICALS = [
  ...
  { slug: 'services.finance', group: 'services', label: 'Finance & Capital', keywords: ['finance', 'financial', 'capital', 'investment', 'investments', 'private equity', 'wealth', 'asset management', 'venture capital', 'fund', 'banking'] },
