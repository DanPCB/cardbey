/**
 * approve_creator_content — Runtime Authority tool.
 */
import { approveCreatorPublishing } from '../../creator/publishing/creatorPublishingService.js';
...
export async function execute(input = {}, context = {}) {
  ...
  try {
    const result = await approveCreatorPublishing(contentId, input, {
