/**
 * schedule_creator_content — Runtime Authority tool.
 */
import { scheduleCreatorPublishing } from '../../creator/publishing/creatorPublishingService.js';
...
export async function execute(input = {}, context = {}) {
  ...
  try {
    const content = await scheduleCreatorPublishing(contentId, input, {
