/**
 * reject_creator_content — Runtime Authority tool.
 */
import { rejectCreatorPublishing } from '../../creator/publishing/creatorPublishingService.js';
...
export async function execute(input = {}, context = {}) {
  ...
  try {
    const content = await rejectCreatorPublishing(contentId, input, {
