/**
 * delete_creator_content — Runtime Authority tool.
 */

import { deleteCreatorContentRecord } from '../../creator/creatorContentService.js';
...
export async function execute(input = {}, context = {}) {
  ...
  try {
    ...
    const content = await deleteCreatorContentRecord(contentId);
    return {
      status: 'ok',
    ...
    return {
      status: 'failed',
      error: { code: 'DELETE_CREATOR_CONTENT_ERROR', message },
    };
  }
}
