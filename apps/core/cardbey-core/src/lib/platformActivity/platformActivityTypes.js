...
export const EVENT_TYPE_CATEGORY = {
  ...
  business_space_published: 'store_lifecycle',
  discovery_seed_converted_to_store: 'business_discovery',
...
export const EVENT_TYPE_DEFAULT_SEVERITY = {
  ...
  business_space_published: 'success',
  discovery_seed_converted_to_store: 'success',
