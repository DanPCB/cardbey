...
export const INVESTOR_ORGANIZATION_CATALOG = [
  ...
  },
  {
    ...
    accessRoute: 'Founder referral',
    publicTeamRoles: ['Partner'],
    relevantPortfolio: ['Australian early-stage technology'],
  ...
  },
  {
    ...
    accessRoute: 'Regional founder intro',
    publicTeamRoles: ['Partner'],
    relevantPortfolio: ['Southeast Asia early-stage'],
  ...
  },
  {
    ...
    accessRoute: 'Regional founder intro',
    publicTeamRoles: ['Partner'],
    relevantPortfolio: ['Southeast Asia technology'],
  ...
  },
  {
    ...
    accessRoute: 'Program application — strategic/program capital',
    publicTeamRoles: ['Program team'],
    relevantPortfolio: ['Accelerator cohorts'],
