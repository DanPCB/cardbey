...
const WANTS_NEED_KEYS: Record<WantsCategory, string[]> = {
  ...
  PARTNER: ['partner', 'expansion', 'business', 'research'],
  INVESTOR: ['investor', 'research', 'expansion'],
  CAPITAL: ['investor', 'growth', 'research', 'expansion'],
...
const INTENT_NEED_KEYS: Partial<Record<MarketIntentFamily, string[]>> = {
  ...
  PARTNER: ['partner', 'business', 'research', 'expansion', 'promotion', 'online_presence'],
  ...
  BUY: ['supply', 'research'],
  SUPPLY: ['supply'],
  INVEST: ['investor', 'research', 'expansion'],
