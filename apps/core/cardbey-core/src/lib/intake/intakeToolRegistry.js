...
or share their website with customers.`,
  ...
  // Typed loyalty topology stages (deterministic spine)
  {
    toolName: 'loyalty.load_store_context',
    executionPath: 'kernel_dispatch',
    label: 'Load store context',
    riskLevel: RISK.SAFE_READ,
    requiresStore: true,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    prerequisiteTools: [],
    parameterSchema: { properties: { storeId: { type: 'string' } } },
    requiredParams: [],
    optionalParams: ['storeId'],
    semanticDescription: 'Load store context for loyalty program setup.',
    examples: [],
  },
  {
    toolName: 'loyalty.analyze_attachment',
    executionPath: 'kernel_dispatch',
    label: 'Analyze uploaded loyalty card',
    riskLevel: RISK.SAFE_READ,
    requiresStore: false,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    requiredParams: [],
    optionalParams: [],
    semanticDescription: 'Analyze uploaded loyalty card attachment.',
    examples: [],
  },
  {
    toolName: 'loyalty.infer_requirements',
    executionPath: 'kernel_dispatch',
    label: 'Infer loyalty requirements',
    riskLevel: RISK.SAFE_READ,
    requiresStore: true,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    requiredParams: [],
    optionalParams: [],
    semanticDescription: 'Infer loyalty requirements and missing owner fields.',
    examples: [],
  },
  {
    toolName: 'loyalty.generate_draft',
    executionPath: 'kernel_dispatch',
    label: 'Generate loyalty draft',
    riskLevel: RISK.STATE_CHANGE,
    requiresStore: true,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    requiredParams: [],
    optionalParams: [],
    semanticDescription: 'Generate loyalty program draft from requirements.',
    examples: [],
  },
  {
    toolName: 'loyalty.validate_draft',
    executionPath: 'kernel_dispatch',
    label: 'Validate loyalty draft',
    riskLevel: RISK.SAFE_READ,
    requiresStore: false,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    requiredParams: [],
    optionalParams: [],
    semanticDescription: 'Validate loyalty program draft fields.',
    examples: [],
  },
  {
    toolName: 'loyalty.persist_draft',
    executionPath: 'kernel_dispatch',
    label: 'Persist loyalty draft',
    riskLevel: RISK.STATE_CHANGE,
    requiresStore: true,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    requiredParams: [],
    optionalParams: ['storeId'],
    semanticDescription: 'Persist loyalty draft on the mission for owner review.',
    examples: [],
  },
  {
    toolName: 'loyalty.present_review',
    executionPath: 'kernel_dispatch',
    label: 'Present owner review',
    riskLevel: RISK.SAFE_READ,
    requiresStore: false,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    requiredParams: [],
    optionalParams: [],
    semanticDescription: 'Present loyalty draft for owner review before apply.',
    examples: [],
  },
  {
  ...
  {
    toolName: 'create_creator_profile',
    executionPath: 'kernel_dispatch',
    ...
    optionalParams: ['displayName', 'username', 'bio', 'categories', 'languages', 'avatar', 'banner'],
    semanticDescription: 'Create a Cardbey Creator profile linked to an existing account. One profile per account.',
    examples: ['become a creator', 'create my creator profile', 'set up creator account'],
  },
  {
    toolName: 'publish_creator_content',
    executionPath: 'kernel_dispatch',
    label: 'Publish Creator Content',
    riskLevel: RISK.STATE_CHANGE,
    requiresStore: false,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    parameterSchema: {
      properties: {
        ...
        type: { type: 'string', enum: ['VIDEO', 'ARTICLE', 'LIVESTREAM'] },
        title: { type: 'string' },
    ...
    requiredParams: [],
    optionalParams: ['contentId', 'creatorId', 'type', 'title', 'description', 'mediaUrl', 'thumbnail', 'durationSeconds', 'language'],
    semanticDescription: 'Publish creator video, article, or livestream placeholder to public profile and creator feed.',
    examples: ['publish my video', 'publish article', 'go live as creator'],
  },
  {
    toolName: 'update_creator_content',
    executionPath: 'kernel_dispatch',
    label: 'Update Creator Content',
    riskLevel: RISK.STATE_CHANGE,
    requiresStore: false,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    requiredParams: ['contentId'],
    optionalParams: ['title', 'description', 'mediaUrl', 'thumbnail', 'durationSeconds', 'status', 'visibility'],
    semanticDescription: 'Update draft or published creator content metadata.',
    examples: ['update my video title', 'save creator draft'],
  },
  {
    toolName: 'delete_creator_content',
    executionPath: 'kernel_dispatch',
    label: 'Delete Creator Content',
    ...
    requiredParams: ['contentId'],
    optionalParams: [],
    semanticDescription: 'Remove creator content from public profile (soft delete).',
    examples: ['delete my video', 'remove creator article'],
  },
  {
    toolName: 'submit_creator_content_for_review',
    executionPath: 'kernel_dispatch',
    label: 'Submit Creator Content for Review',
    riskLevel: RISK.STATE_CHANGE,
    requiresStore: false,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    requiredParams: ['contentId'],
    optionalParams: [],
    semanticDescription: 'Move creator draft content to owner review before publishing.',
    examples: ['submit my video for review', 'send article for owner review'],
  },
  {
    toolName: 'calculate_creator_progress',
    executionPath: 'kernel_dispatch',
    label: 'Calculate Creator Progress',
    riskLevel: RISK.STATE_CHANGE,
    requiresStore: false,
    approvalRequired: false,
    planRole: PLAN_ROLE.STANDALONE,
    ...
    requiredParams: [],
    optionalParams: ['creatorId', 'userId'],
    semanticDescription: 'Recalculate published minutes and 300-minute qualification progress for a creator.',
    examples: ['update creator progress', 'recalculate published minutes'],
  },
];
