...
import { BUSINESS_TOOL_DEFINITIONS } from './business/businessToolRegistry.js';
...
const TOOLS = [
  ...
  { toolName: 'improve_hero', label: 'Improve hero', description: 'Improve store hero image or section', category: 'store', targetTypes: ['store', 'draft_store'], requiresConfirmation: false, aliases: ['hero'] },
  {
    ...
    aliases: ['apply_graphic', 'upload_logo'],
  },
  {
    ...
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
    aliases: ['upload_catalog'],
  },
  {
    toolName: 'validate_store_context',
    label: 'Validate store context',
    description: 'Confirm store or draft context is accessible before catalog workflows',
    category: 'store',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
    aliases: ['validate_store_input'],
  },
  {
    toolName: 'prepare_catalog',
    label: 'Prepare catalog',
    description: 'Load or initialize catalog structure before product upload',
    category: 'store',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
    aliases: ['parse_catalog'],
  },
  {
    toolName: 'finalize_catalog',
    label: 'Finalize catalog',
    description: 'Validate and mark catalog ready after products are added',
    category: 'store',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
  },
  {
    ...
    description: 'Validate uploaded product rows before catalog finalization',
    category: 'store',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
    aliases: ['validate_catalog'],
  },
  {
    toolName: 'manage_product_catalog',
    label: 'Manage product catalog',
    description: 'List, add, update, or summarize store products',
    category: 'store',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
  ...
  },
  {
    ...
    description: 'Checkpoint: choose products for a campaign',
    category: 'promotion',
    targetTypes: ['store', 'promotion'],
    requiresConfirmation: false,
  },
  {
    toolName: 'specify_purpose',
    label: 'Specify graphic purpose',
    description: 'Capture graphic purpose and store context',
    category: 'content',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
  },
  {
    toolName: 'review_graphic',
    label: 'Review graphic',
    description: 'Checkpoint: user reviews generated graphic',
    category: 'content',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
  },
  {
    toolName: 'review_campaign',
    label: 'Review campaign',
    description: 'Checkpoint: user reviews campaign before launch',
    category: 'promotion',
    targetTypes: ['store', 'promotion'],
    requiresConfirmation: false,
  },
  {
    ...
    description: 'Checkpoint: capture extra store requirements from the user',
    category: 'store',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
  },
  ...
  { toolName: 'generate_promotion_asset', label: 'Generate promotion asset', description: 'Generate promotional graphic assets (alias of smart_visual)', category: 'promotion', targetTypes: ['promotion'], requiresConfirmation: false },
  ...
  {
    toolName: 'create_quote_draft',
    label: 'Create quote draft',
    description: 'Draft a commercial Quote (Accounting Documents V1). Does not issue or send.',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
    aliases: ['draft_quote'],
  ...
  {
    toolName: 'update_quote_draft',
    label: 'Update quote draft',
    description: 'Update a draft commercial Quote. Does not issue.',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
  },
  {
    toolName: 'add_quote_item',
    label: 'Add quote item',
    description: 'Add a line item to a draft Quote. Does not invent prices.',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
  },
  {
    toolName: 'prepare_invoice_from_quote',
    label: 'Prepare invoice from quote',
    description: 'Convert an accepted Quote into an Invoice draft',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
    aliases: ['convert_quote_to_invoice'],
  },
  {
    toolName: 'preview_commercial_document',
    label: 'Preview commercial document',
    description: 'Preview Quote or Invoice HTML/PDF representation',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
  },
  {
    toolName: 'issue_quote',
    label: 'Issue quote',
    description: 'Issue a Quote (assigns number + snapshot). Requires owner confirmation.',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: true,
  },
  {
    ...
    label: 'Issue invoice',
    description: 'Issue an Invoice (assigns number + snapshot). Requires owner confirmation.',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: true,
  },
  {
    ...
    label: 'Send document',
    description: 'Share or email an issued Quote/Invoice. Requires owner confirmation.',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: true,
  },
  {
    toolName: 'list_accounting_documents',
    label: 'List quotes & invoices',
    description: 'List commercial Quotes/Invoices for a store (Accounting Documents V1).',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
    aliases: ['list_invoices'],
  },
  {
    toolName: 'get_invoice_summary',
    label: 'Invoice summary',
    description: 'Summary of quotes/invoices including overdue totals for a period.',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
  },
  {
    toolName: 'flag_overdue_invoices',
    label: 'Flag overdue invoices',
    description: 'Find invoices past their due date.',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
  },
  {
    ...
    label: 'Draft chase email',
    description: 'Draft a follow-up email for an overdue invoice (does not send).',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
  },
  {
    ...
    description: 'Markdown revenue/invoice report for a period (read-only).',
    category: 'accounting',
    targetTypes: ['store'],
    requiresConfirmation: false,
  },
  ...
  { toolName: 'smart_visual', label: 'Smart visual', description: 'Generate AI promotional graphics from a text prompt (image + copy + canvas)', category: 'content', targetTypes: ['store', 'draft_store', 'promotion'], requiresConfirmation: false, aliases: ['generate_promo_image'] },
  { toolName: 'create_promotion_graphic', label: 'Create promotion graphic', description: 'One-shot AI promotional graphic: image, copy, branding, Content Studio canvas', category: 'content', targetTypes: ['store', 'draft_store', 'promotion'], requiresConfirmation: false, aliases: ['promotion_graphic', 'promo_graphic', 'generate_graphic'] },
  ...
  { toolName: 'publish_store', label: 'Publish store from draft', description: 'Commit draft to published store (AI operator)', category: 'operator', targetTypes: ['generic'], requiresConfirmation: true, aliases: ['finalize_store'] },
  ...
  {
    toolName: 'mission_conditional_branch',
    label: 'Pipeline conditional branch',
    description: 'Internal: records a conditional branch choice for downstream pipeline steps',
    category: 'operator',
  ...
  },
  {
    ...
    label: 'Pipeline branch stub (legacy alias)',
    description: 'Legacy alias for mission_conditional_branch',
    category: 'operator',
    targetTypes: ['generic', 'store', 'draft_store'],
    requiresConfirmation: false,
  },
  ...
  },
  {
    ...
    description:
      'Analyze loyalty readiness, draft a stamp-card program, suggest rollout, and pause for owner review before apply',
    category: 'loyalty',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: true,
    riskLevel: 'state_change',
  ...
  },
  {
    toolName: 'video_plan',
    label: 'Plan video',
    description: 'Generate video script and scene plan (no external render API)',
    category: 'video',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
    riskLevel: 'safe_read',
  ...
  {
    toolName: 'video_execute',
    label: 'Execute video generation',
    description: 'Run approved video plan through configured provider (Kling)',
    category: 'video',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
    parameters: {
      approvedPlan: { type: 'object', required: true },
    },
  },
  {
  ...
  },
  {
    ...
    description: 'Start structured launch_campaign checkpoint pipeline (research, product pick, creative, launch)',
    category: 'promotion',
    targetTypes: ['store', 'generic'],
    requiresConfirmation: false,
    parameters: {
      storeId: { type: 'string', required: true },
      campaignContext: { type: 'string', required: false },
      hint: { type: 'string', required: false },
      _sourceTool: { type: 'string', required: false },
      _autoSubmit: { type: 'boolean', required: false },
    },
  },
  {
  ...
  {
    toolName: 'resolve_vision_location',
    label: 'Resolve vision location',
    description: 'Resolve GPS from EXIF or client geolocation for vision intake',
    category: 'vision',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
    riskLevel: 'safe_read',
    parameters: {
      imageBuffers: { type: 'array', required: false },
      clientLocation: { type: 'object', required: false },
    },
  },
  {
    toolName: 'classify_vision_event',
    label: 'Classify vision event',
    description: 'Classify photo or scan intent via QR fast path or Claude vision',
    category: 'vision',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
    riskLevel: 'safe_read',
    parameters: {
      decodedPayload: { type: 'string', required: false },
      surface: { type: 'string', required: false },
      defaultIntentHint: { type: 'string', required: false },
      imagePaths: { type: 'array', required: false },
      imageBuffers: { type: 'array', required: false },
    },
  },
  {
    toolName: 'route_vision_event',
    label: 'Route vision event',
    description: 'Route classified vision events to document ingestion, storefront, or stubs',
    category: 'vision',
    targetTypes: ['store', 'draft_store'],
    requiresConfirmation: false,
    riskLevel: 'safe_read',
    parameters: {
      ...
      storeIdHint: { type: 'string', required: false },
      missionId: { type: 'string', required: false },
    },
  },
  {
    toolName: 'create_ghost_store',
    label: 'Create ghost store',
    description: 'Publish an unverified community-captured store from vision extraction',
    category: 'vision',
    targetTypes: ['store'],
    requiresConfirmation: true,
    riskLevel: 'state_change',
    parameters: {
      ...
      visionEventId: { type: 'string', required: false },
      imagePaths: { type: 'array', required: false },
    },
  },
  {
    toolName: 'enrich_ghost_store',
    label: 'Enrich ghost store',
    description: 'Fetch official-site data and licensed media for a ghost store',
    category: 'vision',
    targetTypes: ['store'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
    parameters: {
      storeId: { type: 'string', required: true },
      extraction: { type: 'object', required: false },
    },
  },
];
...
const INTERNAL_MAINTENANCE_TOOLS = [
  ...
  },
  {
    ...
    description: 'Create a Cardbey Creator profile for the authenticated user',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
  ...
  {
    toolName: 'create_creator_content_draft',
    label: 'Create creator content draft',
    description: 'Create creator content in draft status with persisted media metadata',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
  ...
  },
  {
    ...
    description: 'Create draft or publish creator content after owner review',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
  ...
  },
  {
    ...
    description: 'Move creator content from draft to owner review',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
  ...
  {
    toolName: 'return_creator_content_to_draft',
    label: 'Return creator content to draft',
    description: 'Move creator content from owner review back to draft',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
  ...
  },
  {
    ...
    description: 'Update creator content metadata or draft fields',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
  ...
  },
  {
    ...
    description: 'Soft-delete creator content',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
  ...
  {
    toolName: 'classify_creator_content',
    label: 'Classify creator content',
    description: 'Run CreatorClassificationAgent on submitted content',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'safe_read',
    parameters: { userId: { type: 'string', required: true }, contentId: { type: 'string', required: true } },
  },
  {
    toolName: 'approve_creator_content',
    label: 'Approve creator content',
    description: 'Approve creator content for publishing through Publishing Center',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: true,
    riskLevel: 'state_change',
  ...
  {
    toolName: 'request_creator_content_changes',
    label: 'Request creator content changes',
    description: 'Send structured change request to creator',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
  ...
  {
    toolName: 'reject_creator_content',
    label: 'Reject creator content',
    description: 'Reject creator content with creator-visible feedback',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: true,
    riskLevel: 'state_change',
  ...
  {
    toolName: 'escalate_creator_content',
    label: 'Escalate creator content',
    description: 'Escalate creator content for senior review',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'state_change',
  ...
  {
    toolName: 'schedule_creator_content',
    label: 'Schedule creator content',
    description: 'Schedule creator content for future publication',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: true,
    riskLevel: 'state_change',
  ...
  },
  {
    ...
    description: 'Recalculate published minutes and qualification progress',
    category: 'creator',
    targetTypes: ['generic'],
    requiresConfirmation: false,
    riskLevel: 'safe_read',
