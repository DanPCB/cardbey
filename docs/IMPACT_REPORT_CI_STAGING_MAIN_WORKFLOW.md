...
## Directive 3 status (2026-08-12)

**Skipped hard-reset of staging to main.** `origin/staging` and `origin/main` have diverged (~106 / ~125 unique commits). Resetting would drop staging-only history. Continue promoting via PRs: feature ? staging ? main.
